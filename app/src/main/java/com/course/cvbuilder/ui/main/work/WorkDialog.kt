...
class WorkDialog ( ) : DialogFragment() {
    private lateinit var workListner:  OnAddWorkListner
        ...
        val dialog = activity?.let {
            ...
            builder.setView(view).apply {
                ...
                view.findViewById<Button>(R.id.btn_add)?.setOnClickListener {
                    ...
                    workListner.addWork(Work(title, position, duration, R.drawable.ic_work_placeholder))
                    dismiss()
                }
    ...
    fun setWorlListner(addworkListner: OnAddWorkListner){
